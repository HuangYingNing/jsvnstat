...
//	$theme = 'nox';     /* Default CSS theme to use (one of: 'default', 'nox') */
	...
	date_default_timezone_set('Asia/Shanghai'); // depending on your php settings you might want to explicitly set this to your TZ
